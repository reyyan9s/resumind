    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden transition-colors duration-500" style={{ background: t.pageBg }}>
            ...
            >
                ...
                <div className="rounded-[2rem] p-8 lg:p-10 relative overflow-hidden"
                    style={{ background: t.cardBg, border: `1px solid ${t.cardBorder}`, backdropFilter: "blur(24px)", boxShadow: t.cardShadow }}>

                    <div className="text-center mb-8">
                        <h2 className="text-2xl font-semibold tracking-tight mb-2" style={{ color: t.h1 }}>Welcome back</h2>
                        <p className="text-sm" style={{ color: t.sub }}>Login to access your resumes</p>
                    </div>
                        ...
                        <form className="space-y-4" onSubmit={handleEmailSubmit}>
                            ...
                            <div className="space-y-1.5">
                                <div className="flex justify-between pl-1">
                                    <label className="text-xs font-semibold uppercase tracking-wider" style={{ color: t.sub }}>Password</label>
